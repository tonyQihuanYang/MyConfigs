...
-- remap("n", "<leader>nn", "<cmd>NvimTreeToggle<cr>", "Open file browser")
-- remap("n", "<leader>nf", "<cmd>NvimTreeFindFile<cr>", "Find in file browser")
...
-- nvim-dap
remap("n", "<leader>dbb", "<cmd>lua require'dap'.toggle_breakpoint()<cr>", bufopts, "Set breakpoint")
remap("n", "<leader>dbc", "<cmd>lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<cr>", bufopts, "Set conditional breakpoint")
remap("n", "<leader>dbl", "<cmd>lua require'dap'.set_breakpoint(nil, nil, vim.fn.input('Log point message: '))<cr>", bufopts, "Set log point")
remap("n", "<leader>dbr", "<cmd>lua require'dap'.clear_breakpoints()<cr>", bufopts, "Clear breakpoints")
